...
2. Run the **Find my cinema** action: leave the field empty to list every CGR
   cinema, or type a city to filter. The result is shown under the button as
   `Cinema name (ID: P0905)`.
